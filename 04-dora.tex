...
As mentioned in \ref{dora:sec:definition}, application modification includes
not only differences in their source code or executables, but can also include
