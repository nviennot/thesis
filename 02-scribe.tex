...
non-deterministic page faults that could make an instruction be counted twice.
...
This way, \scribe can precisely mark when an asynchronous event is delivered
during the recording, and when to replay it.
...
\racepro and its usage of record-replay techniques that goes beyond deterministic
record-replay in the next chapter.
