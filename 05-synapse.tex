...
and {\code {\small delivery\_mode}}, discussed in \S\ref{sec:semantics}.
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/synapse/diaspora1.pdf}
  ...
  \includegraphics[width=0.8\linewidth]{figures/synapse/diaspora2.pdf}
