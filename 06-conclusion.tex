...
Implementing a hybrid record-replay engine can be done for distributed
applications. \synapse already tracks distributed application state through the DB.
