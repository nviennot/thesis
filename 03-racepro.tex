...
\begin{figure}[t]
  \begin{minipage}{\linewidth}
    ...
    \end{minipage}
  \end{minipage}
  \caption{Wait-wakeups races in streams.}
...
\begin{figure}[t]
  ...
  \begin{minipage}{.55\linewidth}
    ...
    \end{rbox}
  \end{minipage}
  \caption{Replay divergence due to reordering.} \label{racepro:fig:reorder}
\end{figure}
...
\begin{figure}[t]
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{.42\linewidth}
      \begin{rbox}
        ...
        \begin{tabular}{ccc}
                 ...
                 & ...       &                                         \\
          $S_1$: & creat(F); & ...                                     \\
          $S_2$: & ...       & \multicolumn{1}{l}{ r = unlink(F); }    \\
    ...
    \end{minipage}
  \end{minipage}
  \caption{Replay divergence examples.}
