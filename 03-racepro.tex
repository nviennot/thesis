...
\caption{{\bf Process Races Breakdown.} X axis shows the race effect, the number of software
  packages, processes, or programming languages involved.  Y axis shows
  the percentage of process races that involve the specific effect, or number of
